                ...
                >
                    <div class="flex-1 relative overflow-hidden bg-black/30">
                        ...
                        <div class="promo-diag transition-opacity duration-700 group-hover:opacity-0"
                             style="background: {item.ad.gradient || 'linear-gradient(135deg, #2563eb, #9333ea)'}"></div>
                        ...
                        >
                            <div>
                                ...
                                {#if item.ad.hover}
                                    ...
                                    <p class="mt-2 pt-2 border-t border-white/20 text-blue-200 text-[11px] font-bold leading-snug whitespace-pre-line">
                                        {item.ad.hover}
                                    </p>
                                {/if}
                            </div>
