...
// גלובלי לכל הרשת, ו-nc_admin הוא התפקיד המקומי של ועדי שכונות
...
export const ADMIN_ROLES = ['super_admin', 'nc_admin'] as const;
...
function asAdminRole(v: unknown): AdminRole | null {
    return v === 'super_admin' || v === 'nc_admin' ? v : null;
}
