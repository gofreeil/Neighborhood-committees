...
// _site='neighborhoods' — שיוך קשיח לאתר הזה; בלעדיו הפרסומת לא קיימת כאן.
...
// והבדיקה קשיחה: רק 'neighborhoods' שייך לכאן. פרסומת בלי _site היא פרסומת
// ותיקה של "קהילה בשכונה" — לא מוצגת כאן.
const SITE_ID = 'neighborhoods';
