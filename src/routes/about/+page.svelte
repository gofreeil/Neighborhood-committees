...
<article class="space-y-8">
    <div class="rounded-2xl bg-white/5 border border-white/10 p-6 md:p-8 text-gray-300 leading-relaxed space-y-4">
        ...
        <p>
            ועדי שכונות הוא מיזם של התנועה החברתית <a href="https://gofreeil.com" target="_blank" rel="noopener" class="text-white underline decoration-white/40 hover:decoration-white">יוצאים לחירות</a> ומופעל בהתנדבות; האתר הוא חלק מרשת האתרים של התנועה, ומטרתו לתת לקול התושב משקל אמיתי
