<script>
    ...
    // בונה הפרסומות - פורט מקבוצות רכישה (במקור מ"קהילה בשכונה") והותאם לוועדי שכונות:
    ...
    function submitHelp() {
        ...
        const waText =
            `שלום! אני צריך/ה עזרה בעיצוב הפרסומת באתר ועדי שכונות 🆘\n\n` +
            `🧑 ${identity}\n\n` +
            `הבעיה:\n"${problem}"` +
...
<svelte:head>
    <title>בניית הפרסומת שלי | ועדי שכונות | יוצאים לחירות</title>
</svelte:head>
