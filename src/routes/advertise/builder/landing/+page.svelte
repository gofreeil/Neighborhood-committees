<script>
    ...
    function goLoginToSubmit() {
        ...
        void goto(`/login?redirect=${encodeURIComponent("/advertise/builder/landing")}`);
    }
</script>
            ...
            <section class="step-card">
                ...
                {#if editId}
                    ...
                    <div class="pay-box">
                        ...
                        <a href="/advertise/manage/{editId}" class="pay-wa" style="background:#2c3a55">
                ...
                <div class="pay-box">
                    ...
                    {:else}
                        ...
                        <a
                            href={"https://wa.me/972587448061?text=" + encodeURIComponent(`שלום, אני מעלה פרסומת באתר ועדי שכונות ורוצה לתאם תשלום עבור ${payPlan.title} (${payPlan.price} ₪)`)}
                            target="_blank"
...
<style>
    ...
    .l-btn.amber { background: #3b82f6; color: #fff; }
    .l-btn.amber:hover { background: #60a5fa; }
    .l-btn.ghost {
